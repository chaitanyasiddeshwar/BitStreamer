...
| HDR Format | Supported? | Behavior / Handling |
|---|---|---|
...
* **Image Playback Mode:**
  ...
  * **Rewind / Fast Forward Buttons**: Go to the previous or next image in the directory immediately.
  * **Back Button**: Exit image playback.
